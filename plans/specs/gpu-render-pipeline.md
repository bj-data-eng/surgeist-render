...
`plans/P01-surgeist-render/P01-I03-render-pipeline-migration-overlay.md` at
commit `e96614d3eff2667a6b07cbb145873122d4f1f22d`, SHA-256
`9435107b25a4b087de8988603dc8de3ef185a351b646884dc21661d8184322ef`.
It does not turn a
...
### S06B Foundation Adoption Boundary

Published C01 commit `5361e3460278dffb877b9d485a2d12977977c3ef`
is the accepted foundation base. The source-backed successor that reconciled
the provisional identity, async API, terminal-device, capability, scope,
generation, error, and lease work is
`plans/P01-surgeist-render/cycles/P01-I03-S01-C02-foundation-adoption-and-cleanup.md`
at commit `e96614d3eff2667a6b07cbb145873122d4f1f22d`, SHA-256
`b39f8d33efc469f794d96936c591e4cfc0dd795f45e01b1195d57344f20bda92`.
The superseded predecessor contributes no desired-state requirement.

The durable boundary is that renderer, device, and surface identity; async
non-readback operations; terminal signals; immutable capability reports; and
transaction scope, generation, error, and lease semantics must satisfy S07-S13.
External `vello::Renderer::render_to_texture`, external renderer/device slots,
and external surface/setup ownership are not part of the accepted architecture.
Internal raster ownership under S06A precedes the publication, presentation,
readback, and graph phases defined by the later sections.
...
| --- | --- | --- | --- | --- |
| Foreign renderer | `SurfaceRendering` + `ForeignRenderer` | `SurfaceReadback` + `ForeignRenderer` | `SurfaceResume` + `ForeignRenderer` | `Unavailable(SurfaceIdentityMismatch { kind: ForeignRenderer })` |
| Stale device generation | owning operation + `StaleDeviceGeneration` | same | same | `Unavailable(SurfaceIdentityMismatch { kind: StaleDeviceGeneration })` |
...
`plans/P01-surgeist-render/P01-I02-S01-C15-matrix-reconciliation-ledger.md` at
commit `e96614d3eff2667a6b07cbb145873122d4f1f22d`, SHA-256
`03a25cea0214ca53d14eb25e5130902b97e28d830557505322ea01d6bba68d6c`;
no reader must follow the overlay to a second planning source. The listed mixed
boundaries are part of each property's final contract.
