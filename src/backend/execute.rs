#[cfg(test)]
use super::device::{DeviceState, ReadyDeviceState};
#[cfg(any(
...
#[cfg(test)]
use crate::gpu_transaction::test_support::{
...
#[cfg(test)]
use crate::pass::{ColorFilterPreparableGraph, SpatialFilterPreparableGraph};
#[cfg(test)]
use crate::pass::{CorePassCacheRequestsForTest, LayerCompositeCacheRequestsForTest};
#[cfg(test)]
use crate::resource::ResourceManagerObservationForTest;
...
#[cfg(test)]
use crate::surface::{HeadlessResources, RendererIdentity};
#[cfg(any(
    feature = "render-window",
    all(feature = "render-web", target_arch = "wasm32")
))]
...
#[cfg(test)]
use crate::vello_engine::{PreparedVelloPass, VelloAtlasOutcome};
use crate::{
    Antialiasing, BackendErrorCode, Color, EffectQualityPolicy, Error, Format, Parameters,
    PhysicalSize, Result, RuntimeCapabilityUnavailableReason, RuntimeOperation, Stats, Surface,
    gpu_transaction::{
...
#[cfg(test)]
use crate::{Attachment, DeviceLossReason, ErrorCode, FilterList, SurfaceOptions};
...
pub(super) struct InternalVelloRenderRequest<'a> {
    pub(super) identity: DeviceSlotIdentity,
    pub(super) operation: RuntimeOperation,
    pub(super) scene: &'a VelloScene,
    pub(super) target: &'a wgpu::TextureView,
    pub(super) target_extent: PhysicalSize,
    pub(super) base_color: Color,
    pub(super) antialiasing: Antialiasing,
    pub(super) target_usage: wgpu::TextureUsages,
}
...
pub(crate) async fn render_exact_headless_graph_surface(
    ...
    let pending_encoding =
        pending_encoding.map_err(crate::pass::normalize_color_filter_shader_failure_for_test);
