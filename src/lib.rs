...
pub use style::{
    ...
    BorderStyle, BoxDecorationBreak, BoxDecorationFragment, BoxDecorationInput, ClipInput,
    ClipInputKind, FilterAmount, FilterAngle, FilterBlur, FilterList, FilterOp, FilterOpKind,
    FilteredImagePaint, ImageAttachmentPlan, ImagePlacementInput, ImageRepeatMode, ImageRepeatPlan,
    ImageResourceDensity, MaskInput, MaskMode, MaskSource, MaskSourceKind,
    NormalizedBackgroundCommand, NormalizedBackgroundCommandKind, NormalizedBackgroundLayer,
    NormalizedBackgroundLayerSource, NormalizedBackgroundStack, NormalizedBoxRadii, Outline,
